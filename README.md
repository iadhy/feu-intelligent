...
- compte a rebours ;
- boutons Demarrer, Pause, Reprendre, Arreter ;
...
| 2 | Constantes de duree | Les durees du cahier des charges sont centralisees : Rouge 5s, Vert 5s, Jaune 2s, Pieton 6s, extension +3s max +9s. |
